package school.hei.primaryNumber.endpoint.event.model;

import static java.lang.Math.random;
import static school.hei.primaryNumber.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.hei.primaryNumber.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "school.hei.primaryNumber.event1";
    return "school.hei.primaryNumber.event2";
  }
}
