package school.hei.primaryNumber.unit;
...
import school.hei.primaryNumber.conf.FacadeIT;
...
import school.hei.primaryNumber.endpoint.event.consumer.model.TypedEvent;
import school.hei.primaryNumber.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new TypedEvent("school.hei.primaryNumber.endpoint.event.model.UuidCreated", payload);
